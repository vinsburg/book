...
expression with a semicolon. Also notice, `match` variants are enclosed in curly
brackets as usual. As a result, this assignment now ends with a curly bracket, followed by a
semicolon (`};`).
